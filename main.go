...
func main() {
	...
	/*
		...
		En esta trabajaremos las distintas capas (Course, user, enrollment). Y en cada una de estas, le crearemos sus capas
		respectivas: Presentation layer, Business Layer, y Repository Layer
	*/
